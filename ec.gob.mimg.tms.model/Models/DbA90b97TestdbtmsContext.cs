...
public partial class DbA90b97TestdbtmsContext : DbContext
{
    public DbA90b97TestdbtmsContext()
    {
    }

    public DbA90b97TestdbtmsContext(DbContextOptions<DbA90b97TestdbtmsContext> options)
        : base(options)
    {
    }
