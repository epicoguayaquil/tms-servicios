...
{
    public class ApiActivoMilService : IApiActivoMilService
    {
        ...
        public ApiActivoMilService(ILogger<TokenService> logger, ITokenService tokenService)
        {
            ...
            baseUrl = root.GetSection("ApiMimg:url_api").Value + "ssn/ext/cc/ActivoMil/api/";
            //...0991465502001
            _logger = logger;
        ...
        public async Task<DeclaracionResponse> GetByRuc(ContribuyenteApiRequest request)
        {
            ...
            TokenResponse tokenResponse = await _tokenService.GetTokenActivoMil(tokenRequest);
